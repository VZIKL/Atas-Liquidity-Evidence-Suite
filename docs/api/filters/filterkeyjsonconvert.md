# FilterKeyJsonConvert

**完整名称**: `ATAS.Indicators.Filters.Converters.FilterKeyJsonConvert`
**类型**: 类
**继承自**: `ATAS.Indicators.Filters.Converters.FilterJsonConverterBase< FilterKey, CrossKey >`
