# FilterBoolJsonConvert

**完整名称**: `ATAS.Indicators.Filters.Converters.FilterBoolJsonConvert`
**类型**: 类
**继承自**: `ATAS.Indicators.Filters.Converters.FilterJsonConverterBase< FilterBool, bool >`

## 保护方法

  - `override FilterBool Create(bool enabledVisible, bool enabled)`
