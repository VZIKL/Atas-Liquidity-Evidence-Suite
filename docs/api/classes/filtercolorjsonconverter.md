# FilterColorJsonConverter

**完整名称**: `ATAS.Indicators.Filters.Converters.FilterColorJsonConverter`
**类型**: 类
**继承自**: `ATAS.Indicators.Filters.Converters.FilterJsonConverterBase< FilterColor, CrossColor >`
