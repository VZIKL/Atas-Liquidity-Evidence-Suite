# FilterHeatmapTypesJsonConverter

**完整名称**: `ATAS.Indicators.Filters.Converters.FilterHeatmapTypesJsonConverter`
**类型**: 类
**继承自**: `ATAS.Indicators.Filters.Converters.FilterJsonConverterBase< FilterHeatmapTypes, HeatmapTypes >`

## 保护方法

  - `override FilterHeatmapTypes Create(bool enabledVisible, bool enabled)`
