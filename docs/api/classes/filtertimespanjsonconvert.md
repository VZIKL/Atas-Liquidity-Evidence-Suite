# FilterTimeSpanJsonConvert

**完整名称**: `ATAS.Indicators.Filters.Converters.FilterTimeSpanJsonConvert`
**类型**: 类
**继承自**: `ATAS.Indicators.Filters.Converters.FilterJsonConverterBase< FilterTimeSpan, TimeSpan >`
