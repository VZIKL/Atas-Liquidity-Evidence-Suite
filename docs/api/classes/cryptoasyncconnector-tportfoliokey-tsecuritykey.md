# CryptoAsyncConnector< TPortfolioKey, TSecurityKey >

**完整名称**: `ATAS.DataFeedsCore.CryptoAsyncConnector< TPortfolioKey, TSecurityKey >`
**类型**: 类
**继承自**: `ATAS.DataFeedsCore.AsyncConnector< TPortfolioKey, TSecurityKey >`
...
## 公共方法
  ...
  - `abstract Task DropMarketDataConnectionCoupleTimes(int reboots=5)`
...
## 保护方法
  ...
  - `string GetKey()`
  - `string GetSecret()`
  - `async Task OnTestManyReconnections< T >(IEnumerable< T > websockets, int reboots)`
  - ` AsyncConnector()`
